...
public class StudentAssignment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        select = v.findViewById(R.id.student_select);
        upload = v.findViewById(R.id.student_upload);
        filename = v.findViewById(R.id.student_file);
    ...
    private void UploadFile(Uri file) {
        ...
        StorageReference sref = FirebaseStorage.getInstance().getReference().child("Assignments/"+class_id+"/"+name);
